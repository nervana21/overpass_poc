...
run_bitcoind() {
    ...
    # Set BITCOIND_PATH environment variable explicitly
    ...
    echo
    echo "BITCOIND_PATH is set internally to: $bitcoind"
    echo "To use it in your shell environment, run the following:"
    echo
    echo "    export BITCOIND_PATH=\"$bitcoind\""
    echo
}
