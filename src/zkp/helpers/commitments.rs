...
pub fn pedersen_commit(
    ...
    let total: u64 = sender_balance + receiver_balance;
...
mod tests {
    ...
    fn test_pedersen_commit_consistency() {
        ...
        let c1 = pedersen_commit(sender_balance, receiver_balance, blinding, &params);
        let c2 = pedersen_commit(sender_balance, receiver_balance, blinding, &params);
